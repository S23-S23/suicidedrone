...
static const _GuidanceCmd_type_support_symbol_names_t _GuidanceCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, suicide_drone_msgs, msg, GuidanceCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, suicide_drone_msgs, msg, GuidanceCmd)),
  }
};
...
{
  return &::suicide_drone_msgs::msg::rosidl_typesupport_cpp::GuidanceCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, suicide_drone_msgs, msg, GuidanceCmd)() {
  return get_message_type_support_handle<suicide_drone_msgs::msg::GuidanceCmd>();
}
