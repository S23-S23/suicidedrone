...
#include "suicide_drone_msgs/msg/detail/target_info__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = suicide_drone_msgs::msg::TargetInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const suicide_drone_msgs::msg::TargetInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<suicide_drone_msgs::msg::TargetInfo *>(
    untyped_ros_message);
...
{
  return &suicide_drone_msgs::msg::typesupport_fastrtps_cpp::_TargetInfo__handle;
}
