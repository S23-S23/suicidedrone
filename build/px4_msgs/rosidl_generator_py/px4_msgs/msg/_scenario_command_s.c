...
bool px4_msgs__msg__scenario_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._scenario_command.ScenarioCommand", full_classname_dest, 46) == 0);
  }
  px4_msgs__msg__ScenarioCommand * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // param5
    ...
    }
    {
      ...
      Py_ssize_t size = 32;
      uint8_t * dest = ros_message->param5;
...
{
  /* NOTE(esteve): Call constructor of ScenarioCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._scenario_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ScenarioCommand");
  ...
  {  // param5
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "param5");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    uint8_t * src = &(ros_message->param5[0]);
