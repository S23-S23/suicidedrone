...
class GlobalPath_Request(metaclass=Metaclass_GlobalPath_Request):
    ...
    _fields_and_field_types = {
        'waypoints': 'sequence<px4_msgs/TrajectorySetpoint>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['px4_msgs', 'msg'], 'TrajectorySetpoint')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, TrajectorySetpoint) for v in value) and
                 True), \
                "The 'waypoints' field must be a set or sequence and each value of type 'TrajectorySetpoint'"
...
class Metaclass_GlobalPath(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from px4_msgs.srv import _global_path
...
class GlobalPath(metaclass=Metaclass_GlobalPath):
    from px4_msgs.srv._global_path import GlobalPath_Request as Request
    from px4_msgs.srv._global_path import GlobalPath_Response as Response
