...
static const _ModeChange_Request_type_support_symbol_names_t _ModeChange_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, srv, ModeChange_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_msgs, srv, ModeChange_Request)),
  }
};
...
{
  return &::px4_msgs::srv::rosidl_typesupport_cpp::ModeChange_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, px4_msgs, srv, ModeChange_Request)() {
  return get_message_type_support_handle<px4_msgs::srv::ModeChange_Request>();
}
...
static const _ModeChange_Response_type_support_symbol_names_t _ModeChange_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, srv, ModeChange_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_msgs, srv, ModeChange_Response)),
  }
};
...
{
  return &::px4_msgs::srv::rosidl_typesupport_cpp::ModeChange_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, px4_msgs, srv, ModeChange_Response)() {
  return get_message_type_support_handle<px4_msgs::srv::ModeChange_Response>();
}
...
static const _ModeChange_type_support_symbol_names_t _ModeChange_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, srv, ModeChange)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_msgs, srv, ModeChange)),
  }
};
...
{
  return &::px4_msgs::srv::rosidl_typesupport_cpp::ModeChange_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, px4_msgs, srv, ModeChange)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<px4_msgs::srv::ModeChange>();
}
