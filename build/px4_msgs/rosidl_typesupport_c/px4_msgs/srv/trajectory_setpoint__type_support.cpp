...
static const _TrajectorySetpoint_Request_type_support_symbol_names_t _TrajectorySetpoint_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, srv, TrajectorySetpoint_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4_msgs, srv, TrajectorySetpoint_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4_msgs, srv, TrajectorySetpoint_Request)() {
  return &::px4_msgs::srv::rosidl_typesupport_c::TrajectorySetpoint_Request_message_type_support_handle;
}
...
static const _TrajectorySetpoint_Response_type_support_symbol_names_t _TrajectorySetpoint_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, srv, TrajectorySetpoint_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4_msgs, srv, TrajectorySetpoint_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4_msgs, srv, TrajectorySetpoint_Response)() {
  return &::px4_msgs::srv::rosidl_typesupport_c::TrajectorySetpoint_Response_message_type_support_handle;
}
...
static const _TrajectorySetpoint_type_support_symbol_names_t _TrajectorySetpoint_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, srv, TrajectorySetpoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4_msgs, srv, TrajectorySetpoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, px4_msgs, srv, TrajectorySetpoint)() {
  return &::px4_msgs::srv::rosidl_typesupport_c::TrajectorySetpoint_service_type_support_handle;
}
