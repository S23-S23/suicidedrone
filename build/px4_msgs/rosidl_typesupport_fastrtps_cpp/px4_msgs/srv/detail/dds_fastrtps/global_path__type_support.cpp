...
#include "px4_msgs/srv/detail/global_path__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_msgs::srv::GlobalPath_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs::srv::GlobalPath_Request & ros_message)
{
  // Member: waypoints
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_msgs::srv::GlobalPath_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4_msgs::srv::GlobalPath_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::srv::GlobalPath_Request *>(
    untyped_ros_message);
...
{
  return &px4_msgs::srv::typesupport_fastrtps_cpp::_GlobalPath_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, srv, GlobalPath_Request)() {
  return &px4_msgs::srv::typesupport_fastrtps_cpp::_GlobalPath_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_px4_msgs
cdr_serialize(
  const px4_msgs::srv::GlobalPath_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: reply
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs::srv::GlobalPath_Response & ros_message)
{
  // Member: reply
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = px4_msgs::srv::GlobalPath_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4_msgs::srv::GlobalPath_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<px4_msgs::srv::GlobalPath_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &px4_msgs::srv::typesupport_fastrtps_cpp::_GlobalPath_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, srv, GlobalPath_Response)() {
  return &px4_msgs::srv::typesupport_fastrtps_cpp::_GlobalPath_Response__handle;
}
...
{
  return &px4_msgs::srv::typesupport_fastrtps_cpp::_GlobalPath__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, srv, GlobalPath)() {
  return &px4_msgs::srv::typesupport_fastrtps_cpp::_GlobalPath__handle;
}
