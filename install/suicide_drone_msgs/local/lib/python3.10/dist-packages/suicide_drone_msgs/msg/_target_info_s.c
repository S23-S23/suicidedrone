...
bool suicide_drone_msgs__msg__target_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("suicide_drone_msgs.msg._target_info.TargetInfo", full_classname_dest, 46) == 0);
  }
  suicide_drone_msgs__msg__TargetInfo * ros_message = _ros_message;
  {  // header
...
PyObject * suicide_drone_msgs__msg__target_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("suicide_drone_msgs.msg._target_info");
